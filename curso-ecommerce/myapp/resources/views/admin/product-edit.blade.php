      ...
      <form method="POST" enctype="multipart/form-data" action="{{ route('admin.products.update', $product->id) }}">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="p-2 w-full flex flex-col">
            <img class="object-cover object-center block h-[250px] w-[450px]"
              src="{{ \Illuminate\Support\Facades\Storage::url($product->cover) }}" alt="">
          ...
          <div class="p-2 w-full">
            <div class="relative">
              ...
              <textarea id="description" name="description"
                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('name', $product->description) }}</textarea>
            </div>
            @error('description')
            <div class="text-red-400 text-sm">
              {{ $message }}
